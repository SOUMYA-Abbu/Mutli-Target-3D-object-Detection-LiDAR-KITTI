...
launcher = 'none'
load_from = '/raid/cs21resch15003/mmdetection3d/config_loss_modif_train/dual_attention_expt/epoch_150.pth'
log_level = 'INFO'
log_processor = dict(
    by_epoch=True,
...
work_dir = './final_out_loss_modif1/test/kitti_dist_test'
workflow = [
    (
        'train',
        1,
